...
object UKAccount {
  given formats: OFormat[UKAccount] = Json.format[UKAccount]
}

case class InternationalAccount(bicSwiftCode: String, iban: String)

object InternationalAccount {
  given formats: OFormat[InternationalAccount] = Json.format[InternationalAccount]
}

case class EtmpBankDetails(accountName: String,
                       ukAccount: Option[UKAccount] = None,
                       internationalAccount: Option[InternationalAccount] = None)

object EtmpBankDetails {
  given formats: OFormat[EtmpBankDetails] = Json.format[EtmpBankDetails]
}
